...
def data_preprocessing(multiclass=constantes.MULTICLASS,multiclass_target=constantes.MULTICLASS_TARGET_COL):
...
def latentSpace_UMAP(mu, test_labels):
    # Assuming mu is your high-dimensional data
    # You can adjust the number of dimensions in the output using the `n_components` parameter
